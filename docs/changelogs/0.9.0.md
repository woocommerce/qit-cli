...
For detailed information about the new grouping and batching features, please visit our [group tests documentation](https://qit.woo.com/docs/managed-tests/group-tests).
