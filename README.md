...
For detailed instructions, refer to the [official documentation](https://woocommerce.github.io/qit-documentation/#/local-test-environment) or consult the `--help` option in the command line.
