			...
			'test' => [
				'phases' => [
					'run' => [
						...
						'mkdir -p ./results && echo \'{"results":{"summary":{"tests":0,"passed":0,"failed":0},"tests":[]}}\' > ./results/ctrf.json && mkdir -p ./blob-report && echo "test" > test.txt && zip -q ./blob-report/report.zip test.txt && rm test.txt'
					]
				],
				'results' => [
