...
class EnvInfoTests extends QITTestCase {
	...
	public function test_unserialize_env_info() {
		$env_info = json_decode( '{"type":"test","temporary_env":"\/tmp\/test","created_at":123,"status":"running","docker_images":["test1","test2"]}', true );

		$this->assertEquals( 'test', $env_info['type'] );
