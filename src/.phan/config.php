...
return [
    ...
    'suppress_issue_types' => ['PhanUndeclaredConstant'],
    ...
    'autoload_internal_extension_signatures' => [
	    ...
	    // Todo: Use Phan zip instead when it is available in Phan 5.4.2 or higher. (Not released yet by the time this todo is written)
		// 'zip' => '/opt/phan/.phan/internal_stubs/zip.phan_php'
    ],
