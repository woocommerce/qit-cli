...
class OutboundRequest {
    ...
    private array $default_config = [
        ...
        'auth_type' => 'none', // 'none', 'x_node_token', 'bearer'
        'auth_token' => null,
        'additional_headers' => [],
    ...
    public static function callback(string $url, array $data, string $schema_type): self {
        return new self($url, $data, $schema_type, [
            ...
            'auth_type' => 'x_node_token',
            'auth_token' => getenv('QIT_NODE_TOKEN') ?: '',
            'timeout' => 30,
            'max_retries' => 3,
        ]);
    }
     ...
     */
    public static function taskEvent(string $url, array $data, string $schema_type, string $node_token): self {
        return new self($url, $data, $schema_type, [
