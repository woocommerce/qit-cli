...
abstract class Environment {
	...
	public function up( string $type = 'up' ): void {
		...
		if ( ! empty( $this->env_info->plugins ) || ! empty( $this->env_info->themes ) ) {
			...
			if ( ( $this->env_info instanceof \QIT_CLI\Environment\Environments\E2E\E2EEnvInfo || $this->env_info instanceof \QIT_CLI\Environment\Environments\Performance\PerformanceEnvInfo ) && ! empty( $this->env_info->woo ) ) {
