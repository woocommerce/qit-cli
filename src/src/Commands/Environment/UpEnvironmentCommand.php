	...
	protected function doExecute( QITInput $input, OutputInterface $output ): int {
		...
		*/
		...
		$env_info = $env_info_class::from_array( [
			...
			'php_version'             => $env_config['php_version'] ?? $env_config['php'] ?? '8.2',
			'wordpress_version'       => $env_config['wordpress_version'] ?? $env_config['wp'] ?? 'stable',
			'woocommerce_version'     => $env_config['woocommerce_version'] ?? $env_config['woo'] ?? '',
			'sut'                     => $env_config['sut'] ?? [],
